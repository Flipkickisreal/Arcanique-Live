...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v3.0.0"
  WORKING_DIRECTORY "X:/Code Junk/Arcaniquev0_dev/out/build/x64-debug/_deps/ftxui-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'X:/Code Junk/Arcaniquev0_dev/out/build/x64-debug/_deps/ftxui-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'X:/Code Junk/Arcaniquev0_dev/out/build/x64-debug/_deps/ftxui-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
